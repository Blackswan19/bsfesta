document.addEventListener("DOMContentLoaded", function() {
    ...
    if (currentDate <= expirationDate) {
        ...
        const songTitles = ["Young And Beautiful","ELEVEN","That is What I Like","When I Was Your Man","Just the Way You Are","Wake Up in the Sky","Marry You","Locked out of Heaven","Beat It","The Lazy Song","All The Stars","24K Magic"];
